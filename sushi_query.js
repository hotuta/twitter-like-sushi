function SushiQuery(target){
	target = target || {};
	target = SushiHTMLElement(target);
	target = SushiNode(target);
	target = SushiNodeList(target);

	function SushiHTMLElement(target){
		target = target || {};
